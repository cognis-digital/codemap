"""Native cognis-connect emit for codemap — forward findings to any platform.

Maps codemap's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    codemap ... --format json | codemap-emit --to stix
    codemap-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""

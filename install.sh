#!/usr/bin/env sh
# Universal installer for codemap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/codemap.git"
echo "Installing codemap ..."

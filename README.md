...
```bash
pip install "git+https://github.com/cognis-digital/codemap.git"
...
- **MCP server** — `codemap mcp` (Claude Desktop, Cursor, Cognis.Studio, [uncensored-fleet](https://github.com/cognis-digital/uncensored-fleet))
